...
<body class="min-h-screen flex flex-col bg-base-200 font-sans gap-4">
    <nav class="navbar bg-base-100">
        ...
        <div class="navbar-end gap-2">
            ...
            @auth
                ...
                <a href="{{ route('news.index') }}" class='btn btn-sm btn-ghost'>News</a>

                @can('viewAny', auth()->user())
                    <a href="{{ route('users') }}" class='btn btn-sm btn-ghost'>Users</a>
                    <a href="{{ route('signup') }}" class="btn btn-sm btn-ghost">Add Account</a>
                @endcan
    ...
    @if (session('error'))
        <div class="toast toast-top toast-center" style="z-index: 999">
            <div class="alert alert-error bg-red-400 text-gray-800">
